...
edit_options = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton(text="👤 Ism", callback_data="edit_name"), InlineKeyboardButton(text="💵 Narx", callback_data="edit_rate")],
        [InlineKeyboardButton(text="📍 Blok", callback_data="edit_loc")]
    ]
)
